...
@section('main')
    ...
    <div><h1>Welcome to {{$company->company_name}}</h1></div>
    ...
    <div class="row">
        ...
        <div>
            <a style="margin: 19px;" href="/person/create/{{$company->id}}" class="btn btn-primary">Add new person</a>
        </div>
        ...
        <table class="table table-striped">
            ...
            @foreach($company->people as $person)
                <tr>
                    ...
                    <td>
                        <a href="/person/delete/{{$person->id}}" > <button class="btn btn-primary btn-danger" type="submit">Delete</button></a>
    ...
    <div class="row">
        ...
        <div>
            <a style="margin: 19px;" href="/create/{{$company->id}}" class="btn btn-primary">Add new address</a>
                ...
                <div class="col3">
                    <table class="table table-striped">
                        ...
                        @foreach($company->addresses as $address)
                            <tr>
                                <td>{{$address->name}}</td>
                                <td>{{$address->address_latitude}}</td>
                                <td>{{$address->address_longitude}}</td>
                                <td>
                                    <a href="/edit/{{$address->id}}" > <button class="btn btn-primary" type="submit">Edit</button></a>
                                </td>
                                <td>
                                    <a href="/delete/{{$address->id}}" > <button class="btn btn-primary btn-danger" type="submit">Delete</button></a>
                                </td>
